...
// initial source from: https://github.com/JohnRodney/meteor-react-datepicker
function isFunction(object) {
    var getType = {};
    return object && getType.toString.call(object) === '[object Function]'
}

function TinyDatePicker(input, onChangeCallback, options) {
    'use strict';
    ...
    if (isFunction(onChangeCallback)) {
        ...
        console.log("onChange is NOT a function!!! :"+onChangeCallback);
    }
